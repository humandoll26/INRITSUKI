...
1. Node.js をインストールします  
   https://nodejs.org/
2. ターミナルで `node -v` を実行し、Node.js が使えることを確認します
3. このツールでは Node.js を使って `server.mjs` を起動します。追加のビルド作業はありません
4. VOICEVOX をインストールします  
   https://voicevox.hiroshiba.jp/
5. VOICEVOX を起動します
6. ブラウザで `http://127.0.0.1:50021/version` を開き、バージョン文字列が表示されることを確認します
7. このフォルダで `start-server.cmd` を実行します
8. ブラウザで `http://127.0.0.1:5173/` を開きます
9. テキストを入力して `朗読する` を押します
10. 必要なら `動画を保存` で `WebM` を書き出します
